...
internal protocol BinaryEncodable: Encodable {
    func binaryEncode(to encoder: BinaryEncoder) throws
}

/// This is used when an atom has children that need to be prefixed by their size
internal protocol BinarySizedEncodable: BinaryEncodable { }
...
/// compiler.
internal extension BinaryEncodable {
    func binaryEncode(to encoder: BinaryEncoder) throws {
...
internal extension BinaryEncoder {
